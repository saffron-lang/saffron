...
define linkonce_odr i64 @__enum_eq_Option(i64 %a, i64 %b) {
entry:
  %t1 = icmp eq i64 %a, %b
  br i1 %t1, label %eeq.yes5, label %eeq.shape7
eeq.shape7:
  %t2 = lshr i64 %a, 48
  %t3 = lshr i64 %b, 48
  %t4 = icmp ne i64 %t2, 0
  %t5 = icmp ne i64 %t3, 0
  %t6 = or i1 %t4, %t5
  br i1 %t6, label %eeq.no6, label %eeq.null8
eeq.null8:
  %t7 = icmp eq i64 %a, 0
  %t8 = icmp eq i64 %b, 0
  %t9 = or i1 %t7, %t8
  br i1 %t9, label %eeq.no6, label %eeq.tags9
eeq.tags9:
  %t10 = inttoptr i64 %a to i64*
  %t11 = inttoptr i64 %b to i64*
  %t12 = load i64, i64* %t10
  %t13 = load i64, i64* %t11
  %t14 = icmp eq i64 %t12, %t13
  br i1 %t14, label %eeq.disp10, label %eeq.no6
eeq.disp10:
  switch i64 %t12, label %eeq.no6 [ i64 0, label %eeq.v11 i64 1, label %eeq.v12 ]
eeq.v11:
  %t15 = getelementptr i64, i64* %t10, i64 1
  %t16 = load i64, i64* %t15
  %t17 = getelementptr i64, i64* %t11, i64 1
  %t18 = load i64, i64* %t17
  %t19 = icmp eq i64 %t16, %t18
  br i1 %t19, label %eeq.f13, label %eeq.no6
eeq.f13:
  br label %eeq.yes5
eeq.v12:
  br label %eeq.yes5
...
entry:
  ...
  %t17 = load i64, i64* %a
  %t18 = load i64, i64* %b
  %t19 = call i64 @__enum_eq_Option(i64 %t17, i64 %t18)
  %t20 = icmp ne i64 %t19, 0
  %t21 = zext i1 %t20 to i64
  %t22 = call i64 @__val_tag_bool(i64 %t21)
  %t23 = trunc i64 %t22 to i1
  br i1 %t23, label %then14, label %else15
then14:
  %t24 = getelementptr [3 x i8], [3 x i8]* @.str.4, i64 0, i64 0
  %t25 = call i64 @__val_tag_ptr(i8* %t24)
  %t26 = call i64 @__io_println(i64 %t25)
  br label %endif4
else15:
  %t27 = getelementptr [3 x i8], [3 x i8]* @.str.5, i64 0, i64 0
  %t28 = call i64 @__val_tag_ptr(i8* %t27)
  %t29 = call i64 @__io_println(i64 %t28)
  br label %endif4
endif4:
  ...
  %t38 = call i64 @__enum_eq_Option(i64 %t33, i64 %t37)
  %t39 = icmp ne i64 %t38, 0
  %t40 = zext i1 %t39 to i64
  %t41 = call i64 @__val_tag_bool(i64 %t40)
  %t42 = trunc i64 %t41 to i1
  br i1 %t42, label %then17, label %else18
then17:
  %t43 = getelementptr [4 x i8], [4 x i8]* @.str.6, i64 0, i64 0
  %t44 = call i64 @__val_tag_ptr(i8* %t43)
  %t45 = call i64 @__io_println(i64 %t44)
  br label %endif16
else18:
  %t46 = getelementptr [4 x i8], [4 x i8]* @.str.7, i64 0, i64 0
  %t47 = call i64 @__val_tag_ptr(i8* %t46)
  %t48 = call i64 @__io_println(i64 %t47)
  br label %endif16
endif16:
  %t49 = load i64, i64* %a
  %t50 = load i64, i64* %b
  %t51 = call i64 @__enum_eq_Option(i64 %t49, i64 %t50)
  %t52 = icmp eq i64 %t51, 0
  %t53 = zext i1 %t52 to i64
  %t54 = call i64 @__val_tag_bool(i64 %t53)
  %t55 = trunc i64 %t54 to i1
  br i1 %t55, label %then20, label %else21
then20:
  %t56 = getelementptr [5 x i8], [5 x i8]* @.str.8, i64 0, i64 0
  %t57 = call i64 @__val_tag_ptr(i8* %t56)
  %t58 = call i64 @__io_println(i64 %t57)
  br label %endif19
else21:
  %t59 = getelementptr [5 x i8], [5 x i8]* @.str.9, i64 0, i64 0
  %t60 = call i64 @__val_tag_ptr(i8* %t59)
  %t61 = call i64 @__io_println(i64 %t60)
  br label %endif19
endif19:
