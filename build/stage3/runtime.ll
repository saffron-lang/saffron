...
endif343:
  ...
  br i1 %t91, label %then347, label %else348
then347:
  %t92 = load i64, i64* %re
...
while.cond352:
  ...
  %t21 = zext i1 %t22 to i64
  %t23 = trunc i64 %t21 to i1
  br i1 %t23, label %while.body353, label %while.end354
while.body353:
  %t24 = load i64, i64* %data
  %t25 = load i64, i64* %i
  %t26 = add i64 0, 8
...
logic.entry356:
  br i1 %t38, label %rhs357, label %end358
rhs357:
  %t39 = load i64, i64* %re
  %t40 = add i64 0, 0
  %t41 = icmp eq i64 %t39, %t40
  ...
  br label %end358
end358:
  %t44 = phi i1 [%t38, %logic.entry356], [%t43, %rhs357]
  %t45 = zext i1 %t44 to i64
  %t46 = trunc i64 %t45 to i1
  br i1 %t46, label %then359, label %else360
then359:
  %t47 = add i64 0, 1
  ret i64 %t47
else360:
...
logic.entry362:
  br i1 %t52, label %end364, label %rhs363
rhs363:
  %t53 = load i64, i64* %re
  %t54 = add i64 0, 0
  %t55 = icmp eq i64 %t53, %t54
  ...
  br label %end364
end364:
  %t58 = phi i1 [%t52, %logic.entry362], [%t57, %rhs363]
  %t59 = zext i1 %t58 to i64
  %t60 = trunc i64 %t59 to i1
  br i1 %t60, label %then365, label %else366
then365:
  %t61 = load i64, i64* %i
  %t62 = add i64 0, 1
  %t63 = add i64 %t61, %t62
...
endif361:
  ...
  %t72 = zext i1 %t71 to i64
  %t73 = trunc i64 %t72 to i1
  br i1 %t73, label %then368, label %else369
then368:
  %t74 = add i64 0, 1
  ret i64 %t74
else369:
...
entry:
  ...
  br i1 %t8, label %then371, label %else372
then371:
...
endif370:
  ...
  br i1 %t18, label %then374, label %else375
then374:
  %t19 = load i64, i64* %count
...
logic.entry377:
  br i1 %t26, label %end379, label %rhs378
rhs378:
  ...
  br label %end379
end379:
  %t32 = phi i1 [%t26, %logic.entry377], [%t31, %rhs378]
  %t33 = zext i1 %t32 to i64
  %t34 = trunc i64 %t33 to i1
  br i1 %t34, label %then380, label %else381
then380:
...
entry:
  ...
  %t7 = zext i1 %t6 to i64
  %t8 = trunc i64 %t7 to i1
  br i1 %t8, label %then383, label %else384
then383:
  %t9 = add i64 0, 1
...
endif382:
  ...
  %t42 = zext i1 %t41 to i64
  %t43 = trunc i64 %t42 to i1
  br i1 %t43, label %then386, label %else387
then386:
  %t44 = add i64 0, 1
  %t45 = call i8* @malloc(i64 %t44)
  %t46 = ptrtoint i8* %t45 to i64
...
entry:
  ...
  %t7 = zext i1 %t6 to i64
  %t8 = trunc i64 %t7 to i1
  br i1 %t8, label %then389, label %else390
then389:
  %t9 = add i64 0, 0
  ret i64 %t9
else390:
...
endif388:
  ...
  br i1 %t41, label %then392, label %else393
then392:
  %t42 = add i64 0, 0
  ret i64 %t42
else393:
...
endif394:
  ...
  %t16 = zext i1 %t15 to i64
  %t17 = trunc i64 %t16 to i1
  br i1 %t17, label %then398, label %else399
then398:
  %t18 = add i64 0, 0
  ret i64 %t18
else399:
...
endif397:
  ...
  br i1 %t50, label %then401, label %else402
then401:
  %t51 = add i64 0, 0
  ret i64 %t51
else402:
...
endif403:
  ...
  br i1 %t37, label %then407, label %else408
then407:
  ret i64 0
else408:
  br label %endif406
...
entry:
  ...
  %t7 = zext i1 %t6 to i64
  %t8 = trunc i64 %t7 to i1
  br i1 %t8, label %then413, label %else414
then413:
  %t9 = add i64 0, 0
  ret i64 %t9
else414:
...
endif412:
  ...
  br i1 %t20, label %then416, label %else417
then416:
  %t21 = add i64 0, 1
  ret i64 %t21
else417:
...
entry:
  ...
  %t10 = zext i1 %t9 to i64
  %t11 = trunc i64 %t10 to i1
  br i1 %t11, label %then422, label %else423
then422:
  ret i64 0
else423:
  br label %endif421
endif421:
  ...
  %t36 = zext i1 %t35 to i64
  %t37 = trunc i64 %t36 to i1
  br i1 %t37, label %then425, label %else426
then425:
  ret i64 0
else426:
  br label %endif424
...
entry:
  ...
  br i1 %t9, label %then431, label %else432
then431:
  %t10 = load i64, i64* %list
  ret i64 %t10
else432:
...
endif430:
  ...
  br i1 %t92, label %then434, label %else435
then434:
...
while.cond436:
  ...
  br i1 %t109, label %while.body437, label %while.end438
while.body437:
  ...
  br i1 %t117, label %then440, label %else441
then440:
  ...
  br i1 %t129, label %then443, label %else444
then443:
...
endif439:
  ...
  br i1 %t145, label %then446, label %else447
then446:
...
entry:
  ...
  br i1 %t7, label %then449, label %else450
then449:
  %t8 = add i64 0, 1
...
while.body452:
  ...
  br i1 %t42, label %then455, label %else456
then455:
...
while.cond457:
  ...
  br i1 %t9, label %while.body458, label %while.end459
while.body458:
  %t10 = add i64 0, 0
  ...
  %t20 = zext i1 %t21 to i64
  %t22 = trunc i64 %t20 to i1
  br i1 %t22, label %then461, label %else462
then461:
  br label %while.end459
else462:
  br label %endif460
endif460:
  %t23 = load i64, i64* %buf
  ...
  %t32 = zext i1 %t31 to i64
  %t33 = trunc i64 %t32 to i1
  br i1 %t33, label %then464, label %else465
then464:
  br label %while.end459
else465:
  br label %endif463
...
entry:
  ...
  %t12 = zext i1 %t11 to i64
  %t13 = trunc i64 %t12 to i1
  br i1 %t13, label %then467, label %else468
then467:
...
entry:
  ...
  br i1 %t12, label %then470, label %else471
then470:
  %t13 = add i64 0, 1
...
entry:
  ...
  %t7 = zext i1 %t6 to i64
  %t8 = trunc i64 %t7 to i1
  br i1 %t8, label %then473, label %else474
then473:
  %t9 = add i64 0, 1
  %t10 = sub i64 0, %t9
  ret i64 %t10
...
endif472:
  ...
  %t17 = zext i1 %t18 to i64
  %t19 = trunc i64 %t17 to i1
  br i1 %t19, label %then476, label %else477
then476:
...
endif475:
  ...
  br i1 %t23, label %div_err478, label %div_ok479
div_err478:
...
div_ok479:
  ...
  br i1 %t29, label %then481, label %else482
then481:
  %t30 = add i64 0, 128
...
endif480:
  ...
  br i1 %t35, label %div_err483, label %div_ok484
div_err483:
  call i64 @__division_error()
  unreachable
div_ok484:
...
endif485:
  ...
  %t42 = zext i1 %t41 to i64
  %t43 = trunc i64 %t42 to i1
  br i1 %t43, label %then489, label %else490
then489:
  %t44 = add i64 0, 1
  %t45 = call i8* @malloc(i64 %t44)
  %t46 = ptrtoint i8* %t45 to i64
...
while.cond491:
  ...
  br i1 %t93, label %while.body492, label %while.end493
while.body492:
...
while.cond494:
  ...
  br i1 %t11, label %while.body495, label %while.end496
while.body495:
...
entry:
  ...
  %t7 = zext i1 %t6 to i64
  %t8 = trunc i64 %t7 to i1
  br i1 %t8, label %then498, label %else499
then498:
  %t9 = add i64 0, 1
  %t10 = add i64 0, 1
...
while.cond500:
  ...
  %t25 = zext i1 %t26 to i64
  %t27 = trunc i64 %t25 to i1
  br i1 %t27, label %while.body501, label %while.end502
while.body501:
  %t28 = load i64, i64* %rs
...
logic.entry504:
  br i1 %t38, label %end506, label %rhs505
rhs505:
  %t39 = load i64, i64* %ch
  %t40 = add i64 0, 9
  %t41 = icmp eq i64 %t39, %t40
  ...
  br label %end506
end506:
  %t44 = phi i1 [%t38, %logic.entry504], [%t43, %rhs505]
  %t45 = zext i1 %t44 to i64
  %t46 = trunc i64 %t45 to i1
  br label %logic.entry507
logic.entry507:
  br i1 %t46, label %end509, label %rhs508
rhs508:
  %t47 = load i64, i64* %ch
  %t48 = add i64 0, 10
  ...
  br label %end509
end509:
  %t52 = phi i1 [%t46, %logic.entry507], [%t51, %rhs508]
  %t53 = zext i1 %t52 to i64
  %t54 = trunc i64 %t53 to i1
  br label %logic.entry510
logic.entry510:
  br i1 %t54, label %end512, label %rhs511
rhs511:
  %t55 = load i64, i64* %ch
  %t56 = add i64 0, 13
  ...
  br label %end512
end512:
  %t60 = phi i1 [%t54, %logic.entry510], [%t59, %rhs511]
  %t61 = zext i1 %t60 to i64
  %t62 = trunc i64 %t61 to i1
  br i1 %t62, label %then513, label %else514
then513:
...
while.cond515:
  ...
  %t68 = zext i1 %t69 to i64
  %t70 = trunc i64 %t68 to i1
  br i1 %t70, label %while.body516, label %while.end517
while.body516:
  %t71 = load i64, i64* %rs
...
logic.entry519:
  br i1 %t83, label %end521, label %rhs520
rhs520:
  %t84 = load i64, i64* %ch
  %t85 = add i64 0, 9
  ...
  br label %end521
end521:
  %t89 = phi i1 [%t83, %logic.entry519], [%t88, %rhs520]
  %t90 = zext i1 %t89 to i64
  %t91 = trunc i64 %t90 to i1
  br label %logic.entry522
logic.entry522:
  br i1 %t91, label %end524, label %rhs523
rhs523:
  %t92 = load i64, i64* %ch
  %t93 = add i64 0, 10
  ...
  br label %end524
end524:
  %t97 = phi i1 [%t91, %logic.entry522], [%t96, %rhs523]
  %t98 = zext i1 %t97 to i64
  %t99 = trunc i64 %t98 to i1
  br label %logic.entry525
logic.entry525:
  br i1 %t99, label %end527, label %rhs526
rhs526:
  ...
  br label %end527
end527:
  %t105 = phi i1 [%t99, %logic.entry525], [%t104, %rhs526]
  %t106 = zext i1 %t105 to i64
  %t107 = trunc i64 %t106 to i1
  br i1 %t107, label %then528, label %else529
then528:
...
logic.entry531:
  br i1 %t11, label %end533, label %rhs532
rhs532:
  %t12 = load i64, i64* %rn
  %t13 = add i64 0, 0
  %t14 = icmp eq i64 %t12, %t13
  ...
  br label %end533
end533:
  %t17 = phi i1 [%t11, %logic.entry531], [%t16, %rhs532]
  %t18 = zext i1 %t17 to i64
  %t19 = trunc i64 %t18 to i1
  br i1 %t19, label %then534, label %else535
then534:
  %t20 = add i64 0, 0
  %t21 = add i64 0, 1
  %t22 = sub i64 %t20, %t21
...
endif530:
  ...
  %t32 = zext i1 %t31 to i64
  %t33 = trunc i64 %t32 to i1
  br i1 %t33, label %then537, label %else538
then537:
  %t34 = add i64 0, 0
  %t35 = add i64 0, 1
  %t36 = sub i64 %t34, %t35
...
logic.entry540:
  br i1 %t10, label %end542, label %rhs541
rhs541:
  %t11 = load i64, i64* %rc
  %t12 = add i64 0, 0
  ...
  br label %end542
end542:
  %t16 = phi i1 [%t10, %logic.entry540], [%t15, %rhs541]
  %t17 = zext i1 %t16 to i64
  %t18 = trunc i64 %t17 to i1
  br i1 %t18, label %then543, label %else544
then543:
  %t19 = add i64 0, 1
  %t20 = add i64 0, 1
...
while.cond545:
  ...
  br i1 %t48, label %while.body546, label %while.end547
while.body546:
  %t49 = load i64, i64* %buf
  %t50 = inttoptr i64 %t49 to i8*
  %t51 = load i64, i64* %rs
...
entry:
  ...
  %t7 = zext i1 %t6 to i64
  %t8 = trunc i64 %t7 to i1
  br i1 %t8, label %then549, label %else550
then549:
  %t9 = add i64 0, 1
  %t10 = add i64 0, 1
  %t11 = call i64 @__gc_alloc(i64 %t9, i64 %t10)
...
while.cond551:
  ...
  %t29 = zext i1 %t30 to i64
  %t31 = trunc i64 %t29 to i1
  br i1 %t31, label %while.body552, label %while.end553
while.body552:
  %t32 = load i64, i64* %rs
  %t33 = load i64, i64* %i
  %t34 = add i64 %t32, %t33
  ...
  %t40 = zext i1 %t41 to i64
  %t42 = trunc i64 %t40 to i1
  br label %logic.entry555
logic.entry555:
  br i1 %t42, label %rhs556, label %end557
rhs556:
  %t43 = load i64, i64* %ch
  %t44 = add i64 0, 122
  ...
  br label %end557
end557:
  %t48 = phi i1 [%t42, %logic.entry555], [%t47, %rhs556]
  %t49 = zext i1 %t48 to i64
  %t50 = trunc i64 %t49 to i1
  br i1 %t50, label %then558, label %else559
then558:
  %t51 = load i64, i64* %buf
  %t52 = load i64, i64* %i
  %t53 = add i64 %t51, %t52
...
entry:
  ...
  %t7 = zext i1 %t6 to i64
  %t8 = trunc i64 %t7 to i1
  br i1 %t8, label %then561, label %else562
then561:
  %t9 = add i64 0, 1
  %t10 = add i64 0, 1
  %t11 = call i64 @__gc_alloc(i64 %t9, i64 %t10)
...
while.cond563:
  ...
  %t29 = zext i1 %t30 to i64
  %t31 = trunc i64 %t29 to i1
  br i1 %t31, label %while.body564, label %while.end565
while.body564:
  %t32 = load i64, i64* %rs
  %t33 = load i64, i64* %i
  %t34 = add i64 %t32, %t33
...
logic.entry567:
  br i1 %t42, label %rhs568, label %end569
rhs568:
  %t43 = load i64, i64* %ch
  %t44 = add i64 0, 90
  %t46 = icmp sle i64 %t43, %t44
  ...
  br label %end569
end569:
  %t48 = phi i1 [%t42, %logic.entry567], [%t47, %rhs568]
  %t49 = zext i1 %t48 to i64
  %t50 = trunc i64 %t49 to i1
  br i1 %t50, label %then570, label %else571
then570:
  %t51 = load i64, i64* %buf
  %t52 = load i64, i64* %i
  %t53 = add i64 %t51, %t52
...
entry:
  ...
  %t4 = zext i1 %t3 to i64
  %t5 = trunc i64 %t4 to i1
  br i1 %t5, label %then573, label %else574
then573:
  %t6 = call i64 @__list_new()
  ret i64 %t6
else574:
...
while.cond575:
  ...
  br i1 %t17, label %while.body576, label %while.end577
while.body576:
...
entry:
  ...
  %t4 = zext i1 %t3 to i64
  %t5 = trunc i64 %t4 to i1
  br i1 %t5, label %then579, label %else580
then579:
  %t6 = call i64 @__list_new()
  ret i64 %t6
else580:
...
while.cond581:
  ...
  %t13 = zext i1 %t14 to i64
  %t15 = trunc i64 %t13 to i1
  br i1 %t15, label %while.body582, label %while.end583
while.body582:
...
entry:
  ...
  %t4 = zext i1 %t3 to i64
  %t5 = trunc i64 %t4 to i1
  br i1 %t5, label %then585, label %else586
then585:
  %t6 = call i64 @__list_new()
  ret i64 %t6
else586:
...
while.cond587:
  ...
  %t14 = zext i1 %t15 to i64
  %t16 = trunc i64 %t14 to i1
  br i1 %t16, label %while.body588, label %while.end589
while.body588:
  %t17 = add i64 0, 0
...
while.cond590:
  ...
  %t24 = zext i1 %t25 to i64
  %t26 = trunc i64 %t24 to i1
  br i1 %t26, label %while.body591, label %while.end592
while.body591:
  %t27 = load i64, i64* %list
  ...
  br i1 %t39, label %then594, label %else595
then594:
  %t40 = load i64, i64* %list
