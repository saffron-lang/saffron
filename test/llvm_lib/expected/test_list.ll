...
entry:
  ...
  %t1 = ptrtoint i64* %list to i64
  call void @__gc_push_root(i64 %t1)
  %t2 = call i64 @make_list()
  store i64 %t2, i64* %list
  %t3 = load i64, i64* %list
  %t4 = call i64 @__list_to_string(i64 %t3)
  call void @__io_println_str(i64 %t4)
  call void @__gc_pop_roots(i64 1)
  ret i64 0
}
