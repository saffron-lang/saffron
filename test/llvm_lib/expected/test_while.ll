...
while.cond1:
  ...
  br i1 %t7, label %while.body2, label %while.end3
while.body2:
  %t8 = load i64, i64* %total
  %t9 = load i64, i64* %i
  %t10 = add i64 %t8, %t9
  store i64 %t10, i64* %total
  %t11 = load i64, i64* %i
  %t12 = add i64 0, 1
  %t13 = add i64 %t11, %t12
  store i64 %t13, i64* %i
