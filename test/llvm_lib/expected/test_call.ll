...
define i64 @apply_twice(i64 %x.arg) {
entry:
  %x = alloca i64
  %first = alloca i64
  %second = alloca i64
  store i64 %x.arg, i64* %x
  %t1 = load i64, i64* %x
  %t2 = call i64 @double(i64 %t1)
  store i64 %t2, i64* %first
  %t3 = load i64, i64* %first
  %t4 = call i64 @double(i64 %t3)
  store i64 %t4, i64* %second
  %t5 = load i64, i64* %second
  ret i64 %t5
}
...
entry:
  %result = alloca i64
  %t1 = add i64 0, 3
  %t2 = call i64 @apply_twice(i64 %t1)
