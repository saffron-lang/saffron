...
Pantry.project(fun (p: Pantry.Project) {
    ...
    p.dep("turmeric", path: "../../turmeric", version: "^0.1.0")
    p.dep("http", "^2.0.0")
...
Pantry.project(fun (p: Pantry.Project) {
    ...
    p.plugin("pantry-docker", "^1.0.0")  // adds: pantry docker build
